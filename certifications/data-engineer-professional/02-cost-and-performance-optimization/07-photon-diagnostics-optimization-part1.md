...
> For EXPLAIN plans and AQE internals, see [EXPLAIN Plans & Adaptive Query Execution](./06-explain-plans-aqe.md).
...
> **Continue reading:** [Part 2 — Query Optimization Strategies, Common Issues & Exam Tips](./07-photon-diagnostics-optimization-part2.md)

---

**[← Previous: EXPLAIN Plans & Adaptive Query Execution](./06-explain-plans-aqe.md) | [↑ Back to Performance Optimization](./README.md) | [Next: Photon, Diagnostics & Query Optimization — Part 2](./07-photon-diagnostics-optimization-part2.md) →**
