...
> For Photon acceleration, memory diagnostics, and Spark UI analysis, see [Part 1](./07-photon-diagnostics-optimization-part1.md).
...
**[← Previous: Photon, Diagnostics & Query Optimization — Part 1](./07-photon-diagnostics-optimization-part1.md) | [↑ Back to Performance Optimization](./README.md) | [Next: Streaming Performance Optimization](./08-streaming-optimization.md) →**
