...
**[← Previous: Declarative Pipelines](../01-developing-code-for-data-processing/06-declarative-pipelines.md) | [↑ Back to Lakeflow Pipelines](./README.md) | [Next: APPLY CHANGES API](./04-apply-changes-api.md) →**
