...
> For CDC fundamentals, Delta CDF, APPLY CHANGES, and SCD patterns, see [Part 1](./01-change-data-capture-part1.md).
...
**[← Previous: Change Data Capture (CDC) — Part 1](./01-change-data-capture-part1.md) | [↑ Back to Data Processing](./README.md) | [Next: Delta Lake Operations — Part 1](../01-developing-code-for-data-processing/04-delta-lake-operations-part1.md) →**
