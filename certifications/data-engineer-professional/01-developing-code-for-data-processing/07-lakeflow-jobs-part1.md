...
> **Continue reading:** [Part 2 — Triggers, Compute, Notifications, Parameters, Error Handling & Exam Tips](./07-lakeflow-jobs-part2.md)

---

**[← Previous: APPLY CHANGES API](../03-data-transformation-cleansing-quality/04-apply-changes-api.md) | [↑ Back to Lakeflow Pipelines](./README.md) | [Next: Lakeflow Jobs — Part 2](./07-lakeflow-jobs-part2.md) →**
