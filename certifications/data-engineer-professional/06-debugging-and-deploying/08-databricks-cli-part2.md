...
- [REST API — Part 1](./09-rest-api-part1.md) - Programmatic API access
- [Asset Bundles](../06-debugging-and-deploying/01-asset-bundles-part1.md) - Infrastructure as code
- [CI/CD Integration](../06-debugging-and-deploying/02-cicd-integration-part1.md) - Pipeline automation
...
**[← Previous: Databricks CLI — Part 1](./08-databricks-cli-part1.md) | [↑ Back to Databricks Tooling](./README.md) | [Next: REST API — Part 1 (Jobs, Clusters, DBFS & Workspace APIs)](./09-rest-api-part1.md) →**
