...
> For API basics, authentication, Jobs API, Clusters API, DBFS API, and Workspace API, see [Part 1](./09-rest-api-part1.md).
...
**[← Previous: REST API — Part 1 (Jobs, Clusters, DBFS & Workspace APIs)](./09-rest-api-part1.md) | [↑ Back to Databricks Tooling](./README.md) | [Next: Databricks Compute](../02-cost-and-performance-optimization/09-databricks-compute.md) →**
