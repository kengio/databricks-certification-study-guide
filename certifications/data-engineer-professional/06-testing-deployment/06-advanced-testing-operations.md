---
title: Advanced Testing & Operations
type: topic
tags:
  - data-engineering
  - testing
...
This guide covers advanced testing strategies for Databricks — property-based testing, DLT testing, streaming pipeline testing, integration testing, deployment validation, and GitOps patterns.

> For bundle configuration, deployment strategies, and OIDC setup, see [Bundle Deployment Strategies](./05-bundle-deployment-strategies.md).
