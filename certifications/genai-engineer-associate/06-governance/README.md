...
> [!important]
> **New in the March 2026 blueprint.** Governance is now a first-class 8 % domain covering how Unity Catalog governs AI assets, how PII is handled in GenAI pipelines, and how content safety / Unity AI Gateway guardrails protect production deployments.
...
flowchart LR
    ...
    Gov --> AIG[Unity AI Gateway policies]
```
...
| File | Topic | Priority |
| :--- | :--- | :--- |
| [01-governance-overview.md](./01-governance-overview.md) | UC for embeddings/models/prompts, PII redaction, content safety, Unity AI Gateway guardrails | High |
...
| **Unity AI Gateway guardrails** | Per-endpoint policies for rate limit, content filtering, prompt injection detection |
