...
Core Python concepts for data engineers. This file covers the language mechanics assumed by
PySpark, MLflow, and the Databricks SDK. For advanced patterns (generators, decorators,
context managers, ABC, testing), see [Python for Production Data Engineering](../interview-prep/09-python-code-quality.md).
